...
Layout mirrors Dettol: 2-col grid — **left** = breadcrumb, H1, short desc, pill selectors; **right** = the product photo, large, on **white**. On mobile (<900px) the photo goes on top and the copy centres. Deliberately minimal: **no eyebrow, no chosen-variant summary line, no retailer/Amazon buttons.**
