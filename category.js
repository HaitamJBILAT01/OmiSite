...
(function () {
  ...
  function featIcon(f, i) {
    return READY.indexOf(f.icon) !== -1
      ? `<span class="trust-icon" style="--ti:url('assets/${f.icon}.svg?v=154')" aria-hidden="true"></span>`
  ...
  if (mediaEl) mediaEl.style.backgroundImage = `url("${encodeURI("assets/" + BANNER)}?v=154")`;
